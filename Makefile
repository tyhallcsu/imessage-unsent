...
PYTHON_SOURCES := scripts/decode.py scripts/lib/wal_extract.py scripts/lib/recovery_selection.py scripts/lib/json_report.py scripts/lib/batch_report.py scripts/lib/iphone_backup.py tests/python/conftest.py tests/python/test_decode.py
